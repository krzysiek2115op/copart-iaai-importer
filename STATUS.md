...
(wtyczka 0.24.0: auto-podstrona „Nasze auta" z shortcode po aktywacji + wpięcie do menu +
...
sitemap przez rdzeń WP. Schemat audytu wyciągnięty do `vehicle.schema.json`.
Pełna instrukcja klienta A–Z w jednym pliku: `docs/klient/PRZECZYTAJ-MNIE-NAJPIERW.md`)
