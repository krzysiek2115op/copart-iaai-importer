...
function iaai_create_landing_page() : void {
	...
	if ( ! $id ) {
		$id = wp_insert_post( array(
			...
			'post_status'  => 'publish',
			'post_type'    => 'page',
			'post_content' => "<p>" . esc_html__( 'Aktualna oferta pojazdów z aukcji IAAI i Copart — zdjęcia, przebieg, zakres uszkodzeń i pełne dane techniczne każdego auta. Lista odświeża się automatycznie.', 'iaai-importer' ) . "</p>\n[iaai_pojazdy ile=\"24\"]",
		) );
