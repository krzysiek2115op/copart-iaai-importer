...
import argparse, json, subprocess, sys, urllib.robotparser
...
def main():
    ...
    step("1b szczegóły", d1, ["szczegoly.py", "--in", str(listings), "--out", str(W / "szczegoly.jsonl")], kg)
    step("1c zdjęcia", d1, ["zdjecia.py", "--in", str(listings), "--out", str(W / "zdjecia.jsonl")], kg)
